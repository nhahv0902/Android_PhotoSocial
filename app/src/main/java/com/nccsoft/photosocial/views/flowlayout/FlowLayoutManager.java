...
public class FlowLayoutManager extends RecyclerView.LayoutManager {
    ...
    private boolean childVisible(boolean preLayout, int left, int top, int right, int bottom) {
        return recyclerView.getLayoutParams().height == ViewGroup.LayoutParams.WRAP_CONTENT || Rect.intersects(new Rect(leftVisibleEdge(), topVisibleEdge(), rightVisibleEdge(), bottomVisibleEdge()), new Rect(left, top, right, bottom));
    }

    private boolean childVisible(boolean preLayout, Rect childRect) {
        return !preLayout && recyclerView.getLayoutParams().height == ViewGroup.LayoutParams.WRAP_CONTENT || Rect.intersects(new Rect(leftVisibleEdge(), topVisibleEdge(), rightVisibleEdge(), bottomVisibleEdge()), childRect);
    }
